...
// linker flag:
//   $> go build -ldflags "-X github.com/dihedron/graphstack/build.GitHash=$(hash)"
...
//   $> nm ./graphstack | grep GitHash
//   00000000015db9c0 b github.com/dihedron/graphstack/build.GitHash
